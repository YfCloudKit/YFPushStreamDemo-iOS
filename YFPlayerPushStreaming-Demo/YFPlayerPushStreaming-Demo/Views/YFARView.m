...
- (instancetype)init{
    if (self = [super init]) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            [arview setBackgroundImage:[UIImage imageNamed:@"selected"] forState:UIControlStateSelected];
            if (i == 0) {
                [arview setTitle:@"无" forState:UIControlStateNormal];
            }else{
                [arview setTitle:[NSString stringWithFormat:@"%d",i] forState:UIControlStateNormal];
            }
