...
- (NSArray *)dataArr{
    if (!_dataArr) {
        _dataArr = @[@{@"iconNomal":@"beauty",@"iconSelected":@"beauty22",@"title":@"美颜"},@{@"iconNomal":@"ar1",@"iconSelected":@"ar2",@"title":@"AR直播"},@{@"iconNomal":@"shuiyin",@"iconSelected":@"shuiyin2",@"title":@"水印"},@{@"iconNomal":@"erfan3",@"iconSelected":@"erfan",@"title":@"耳返/关"},@{@"iconNomal":@"jiangzao3",@"iconSelected":@"jiangzao",@"title":@"降噪/关"},@{@"iconNomal":@"jingyin",@"iconSelected":@"jingyin3",@"title":@"静音/关"},@{@"iconNomal":@"rizhi3",@"iconSelected":@"rizhi",@"title":@"日志/关"},@{@"iconNomal":@"mirror",@"iconSelected":@"mirror3",@"title":@"镜像/开"}];
